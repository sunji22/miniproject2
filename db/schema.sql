...
CREATE TABLE challenge (
    ...
    status         VARCHAR(255) NOT NULL DEFAULT 'RECRUITING', -- enum ChallengeStatus: RECRUITING/ONGOING/CLOSED/DELETED
...
CREATE TABLE participation (
    ...
    status           VARCHAR(20) NOT NULL DEFAULT 'JOINED', -- enum ParticipationStatus: JOINED/SUCCESS/FAILED/CANCELED
    created_at       DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
...
CREATE TABLE refresh_token (
    ...
    created_at       DATETIME(6)  NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    PRIMARY KEY (refresh_token_id),-- 보증금 챌린지 - DB 스키마
